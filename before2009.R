...
#导入数据
#数据1
SP500 = read.csv('C:/Users/Administrator/Desktop/dccgarch/dcc3/Index/S&P500^GSPC.csv' ,
              header = T)
...
#数据2
nasdaq = read.csv('C:/Users/Administrator/Desktop/dccgarch/dcc3/Index/Nasdaq^IXIC.csv' ,
                 header = T)
...
#数据3
DJI = read.csv('C:/Users/Administrator/Desktop/dccgarch/dcc3/Index/DowJones^DJI.csv' ,
                 header = T)
DJI = DJI[,c('Date','Open')]
...
#数据4
VIT = read.csv('C:/Users/Administrator/Desktop/dccgarch/dcc3/Index/Volatility^VIX.csv' ,
                 header = T)
VIT = VIT[,c('Date','Open')]
...
# 时间区间
startday = DJI$Date[1]
endday = as.Date("2009-10-1","%Y-%m-%d")
# str(BTC)
